...
<template>
    <creatorNav />
    <div class="heading">
        <h3 class="green">Album Upload</h3>
    </div>
    <div v-show="songsDone==false" class="container col-md-4 col-md-offset-4" style="margin-top: 2%;">
    ...
    <div v-show="songs>0" class="container col-md-4 col-md-offset-4" style="margin-top: 0%;">
        Songs added:<br>
        <div>
            {{ songs}}
        </div>
