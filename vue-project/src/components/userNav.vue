<template>
    <nav class="navbar navbar-expand-md navbar-light">
        ...
        <div class="mx-auto order-1 abs-center-x">
            <ul class="navbar-nav mr-auto">
            <li class="nav-item"><a class="nav-link"><RouterLink to="/home">Home</RouterLink></a></li>
            <li class="nav-item"><a class="nav-link"><RouterLink to="/playlists">Playlists</RouterLink></a></li>
            <li class="nav-item"><a class="nav-link"><RouterLink to="/profile">Profile</RouterLink></a></li>
            </ul>
        </div>
