<template>
    <div v-if="albums" class="container" style="margin-top: 2%; margin-bottom: 0%;">
                <h3><strong>Flagged Albums</strong></h3>
        </div>
            ...
            <div class="d-flex card-container CC-2  col-10" style="height: 38vh; width:100% ;justify-content: left;">
                <div v-for="album in albums" :key="album.album_id" class="card mb-3">
                        ...
                        <div class="card-footer">
                            ...
                            <button class="btn btn-outline-danger" @click="unflagAlbum(album.album_id)">Un-Flag</button>
                        </div>
                </div>
            </div>
            <div class="arrow-buttons">
    ...
    export default {
        ...
        methods: {
            getAlbums() {
                axios.get(`${API_BASE_URL}/albums?flag=true`,{
                    headers: {
            ...
            unflagAlbum(album_id) {
                console.log(`Un-Flagging album ${album_id}`)
