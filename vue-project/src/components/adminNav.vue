<template>
    <nav class="navbar navbar-expand-md navbar-light">
        ...
        <div class="mx-auto order-1 abs-center-x">
            <ul class="navbar-nav mr-auto">
            <li class="nav-item"><a class="nav-link nav-link-1"><RouterLink to="/dashboard">Dashboard</RouterLink></a></li>
            <li class="nav-item"><a class="nav-link nav-link-2"><RouterLink to="/uploads">Uploads</RouterLink></a></li>
            <li class="nav-item"><a class="nav-link nav-link-2"><RouterLink to="/flagged">Blacklist</RouterLink></a></li>
            </ul>
        </div>
